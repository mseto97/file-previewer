...
//  MediaLibraryManager
//
//  Created by Daniela Lemow and Megan Seti on 30/08/18.
...
/**
 * A class with functions that allow us to check if imported json files are valid,
 * If they are invalid, will indicate why they are invalid
 */
class FileValidator {
    ...
    ///
    /// Checks if a file has a filepath and a legal type (audio, document, video, image)
    ///
    /// - Parameters:
